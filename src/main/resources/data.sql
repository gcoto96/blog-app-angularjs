insert into posts (id, title, content ,author,image,created_at,updated_at) values
 (601 , 'My first angular app'            ,'lorem','nasheikh',null,'2017-04-11','2017-04-11')
...
/* Products */
insert into accounts (id, product_code, product_name, description, standard_cost, list_price, target_level, reorder_level, minimum_reorder_quantity, quantity_per_unit, discontinued, category) values
